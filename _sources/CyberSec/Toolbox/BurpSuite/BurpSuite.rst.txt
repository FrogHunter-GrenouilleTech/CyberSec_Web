...
####
    ...
    .. note:: 
        ...
        **Liens Web**
         ...
         * `Installing Burp's CA certificate`_
         * `How To Setup BurpSuite and Zap With FoxyProxy on Kali`_

.. _`Installing Burp's CA certificate`: https://portswigger.net/burp/documentation/desktop/external-browser-config/certificate
